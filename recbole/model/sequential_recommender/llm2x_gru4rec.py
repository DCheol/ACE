...
class LLM2X_GRU4Rec(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        super(LLM2X_GRU4Rec, self).__init__(config, dataset)
    ...
    def _init_weights(self, module):
        if isinstance(module, (nn.Embedding)) and module is not self.item_embedding:
