...
class WhitenRec_GRU4Rec(SequentialRecommender):
    ...
    def __init__(self, config, dataset):
        super(WhitenRec_GRU4Rec, self).__init__(config, dataset)
        ...
        self.item_embedding = WhitenRec_Item_Embedding(config, mapped_feat, self.n_items, self.embedding_size, scale=None, padding_idx=0, )
