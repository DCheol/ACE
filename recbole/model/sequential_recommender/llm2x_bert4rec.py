...
class LLM2X_BERT4Rec(SequentialRecommender):
    def __init__(self, config, dataset):
        super(LLM2X_BERT4Rec, self).__init__(config, dataset)
        ...
        reduced_llm_item_emb = np.concatenate((np.zeros((1, self.hidden_size)), reduced_llm_item_emb, np.zeros((1, self.hidden_size))), axis=0)  # zero padding for [PAD] token
