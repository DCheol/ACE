...
class AlphaRec_BERT4Rec(SequentialRecommender):
    def __init__(self, config, dataset):
        super(AlphaRec_BERT4Rec, self).__init__(config, dataset)
        ...
        self.item_embedding = AlphaRec_Item_Embedding(config, mapped_feat, self.n_items + 1, self.hidden_size, scale=None, padding_idx=0, )
